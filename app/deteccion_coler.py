...
data_gen_entrenamiento = datagen.flow_from_directory(train_dir, target_size=(128, 128),  # Tamaño de imagen reducido
                                                    batch_size=64,  # Aumentar tamaño de batch
                                                    shuffle=True, 
                                                    subset='training')
data_gen_pruebas = datagen.flow_from_directory(train_dir, target_size=(128, 128),
                                                batch_size=64, 
                                                shuffle=True, 
                                                subset='validation')
